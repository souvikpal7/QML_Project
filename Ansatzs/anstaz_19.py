...
class Ansatz19:
    ...
    def get_circ_1(self) -> Any:
        ...
        paravec = ParameterVector("ip", num_par)
    ...
    def get_circ_5(self) -> Any:
        ...
        paravec = ParameterVector("ip", 2)
        paravec_2 = ParameterVector("ip1", self.feature_dim * (self.feature_dim - 1) // 2)
        blocks = []
    ...
    def get_circ_9(self) -> Any:
        ...
        paravec = ParameterVector("ip", num_pars)
        arg_count = 0
        circ = QuantumCircuit(self.feature_dim)
        for _ in range(self.repitition):
...
if __name__ == "__main__":
    circuit_id = 1
    # anstz19 = Ansatz19(1, 7, circuit_id).get_ansatz()
    anstz19 = Ansatz19(1, 7, circuit_id)
    circuit = anstz19.get_ansatz()
